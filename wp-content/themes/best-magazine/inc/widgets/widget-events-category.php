...
class best_magazine_events_categ extends WP_Widget
{
    ...
    parent::__construct(false,$name=sprintf(__( '%s Events Categories Posts', "best-magazine" ), WDWT_TITLE ),$widget_ops,$control_ops);
  }
      ...
      while ($wp_query->have_posts()) : $wp_query->the_post();
        ?>
            ...
            <div class="events-widg">               
             <p>
              <?php  echo Best_magazine_front_functions::the_excerpt_max_charlength(150);  ?>
             </p>
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
        //Defaults
    $instance = wp_parse_args( (array) $instance, array( 'title'=>__('Events Categories Posts', "best-magazine"), 'categ_id'=>'0', 'post_count'=>'3' ) );
