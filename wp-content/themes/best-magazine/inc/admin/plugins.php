...
function wdwt_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			'page_title'                      => __( 'Install Recommended Plugins', "best-magazine" ),
			'menu_title'                      => __( 'Recommended Plugins', "best-magazine" ),
			'installing'                      => __( 'Installing Plugin: %s', "best-magazine" ), // %s = plugin name.
			...
			'activate'                        => __( 'Activate', "best-magazine" ),
			...
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', "best-magazine" ),  // %1$s = plugin name(s).
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', "best-magazine" ),  // %1$s = plugin name(s).
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', "best-magazine" ), // %s = dashboard link.
